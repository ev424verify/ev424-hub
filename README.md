...
Note: This document defines the contract; implementation may be added in later commits. Don’t trust claims. Trust the exit code, SHA-256, and the normalized JSON.
